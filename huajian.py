...
def display_instances(name, annotations, figsize=(16, 16)):
    ...
    plt.savefig("E:/boundary_results_WHU/Mask_RCNN_DP/image_results/" + os.path.splitext(name)[0] + ".jpg")
    plt.close()

indir = "D:/boundary-optimized/Mask_RCNN_spacenet/json_results/"
outdir = "E:/boundary_results_WHU/Mask_RCNN_DP/json_results/"
