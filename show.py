...
# 原coco数据集的路径
dataDir = "D:/spacenet/train2014/"
annFile = 'D:/spacenet/annotations/instances_train2014.json'
imagesave = "D:/spacenet/train/show/"
...
def display_instances(name, annotations, figsize=(16, 16)):
    ...
    image = plt.imread(dataDir+os.path.splitext(name)[0]+".jpg")
