...
annFile = 'D:/spacenet/annotations/instances_minival2014.json'
# 用于保存新生成的mask数据的路径
masksave = "D:/spacenet/val/cut_mask/"
imagesave = "D:/spacenet/val/cut_image/"
jsonsave = "D:/spacenet/val/"
...
def get_mask_data(insize, outsize):
    ...
    for imageinfo in image_info_list:
        ...
        for i, anns in enumerate(anns_list):
            ...
            cv2.imwrite(masksave + file_name, msk)
